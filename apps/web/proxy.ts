...
export function proxy(req: NextRequest) {
  ...
  // --- Cohort override: root path for logged-out users redirects to
  // /login. The upstream Multica LP is not shown on this deployment
  // because we run a private, workspace-bound experience. ---
